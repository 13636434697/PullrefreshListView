package com.xu.pullrefreshlistview.ui;
...
import com.xu.pullrefreshlistview.R;
...
public class RefreshListView extends ListView implements OnScrollListener{
	...
	private void initHeaderView() {
		...
		// 提前手动测量宽高（因为这个方法在构造函数里面执行，而构造函数在onmeseru里面执行，所以还没有oncereate了就去测量就没有数值了）
		//getHeight()这个是画出来的效果界面上的高度（onresezm之后的方法），getMeasuredHeight这个是测量的结果真实的高度
